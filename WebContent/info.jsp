...
<%
		   ...
		   try{
			      ...
			      if(conn != null){
			    	  sql = "select mem_idx, mem_userid, mem_userpw, mem_name, mem_hp, mem_email, mem_hobby, mem_ssn1, mem_ssn2, mem_zipcode, mem_address1, mem_address2, mem_address3 from tb_member where mem_userid=?";
...
<body>
    ...
    <form action="info_ok.jsp" name="regform" id="regform" method="post" onsubmit="return sendit()">
        ...
        <p><label>이름 : <input type="text" name="name" id="name" value="<%=mem_name%>"></label></p>
...
%>
        ></label></p>
        <p>주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6" value="<%=mem_ssn1 %>"> - <input type="password" name="ssn2" id="ssn2" value="<%=mem_ssn1 %>"> <input type="button" value="주민등록번호 검증" id="ssnBtn"></p>
        <p><label>우편번호 : <input type="text" name="zipcode" id="sample6_postcode" readonly value="<%=mem_zipcode %>"></label>
